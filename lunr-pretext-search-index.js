...
{
  "id": "population-agent-density-dependent-7",
  "level": "2",
  "url": "population-agent-based.html#population-agent-density-dependent-7",
  "type": "Figure",
  "number": "2.1.9",
  "title": "",
...
{
  "id": "population-agent-density-dependent-8",
  "level": "2",
  "url": "population-agent-based.html#population-agent-density-dependent-8",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
{
  "id": "population-agent-density-dependent-9",
  "level": "2",
  "url": "population-agent-based.html#population-agent-density-dependent-9",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "equilibrium "
...
{
  "id": "population-agent-density-dependent-10",
  "level": "2",
  "url": "population-agent-based.html#population-agent-density-dependent-10",
  "type": "Figure",
  "number": "2.1.10",
  "title": "",
  "body": "  Plot of birth and death rates for each time step of the simulation with respect to the population size at the beginning of that time step for the density-dependent model.  "
},
{
  "id": "population-agent-density-dependent-11",
  "level": "2",
  "url": "population-agent-based.html#population-agent-density-dependent-11",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "net growth rate "
},
{
  "id": "population-agent-density-dependent-12",
  "level": "2",
  "url": "population-agent-based.html#population-agent-density-dependent-12",
  "type": "Figure",
  "number": "2.1.11",
  "title": "",
  "body": "  Plot of birth and death rates for each time step of the simulation with respect to the population size at the beginning of that time step for the density-dependent model.  "
...
{
  "id": "population-sequences-5",
  "level": "2",
  "url": "population-discrete.html#population-sequences-5",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
{
  "id": "population-sequences-6",
  "level": "2",
  "url": "population-discrete.html#population-sequences-6",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
{
  "id": "population-constant-per-capita-2",
  "level": "2",
  "url": "population-discrete.html#population-constant-per-capita-2",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
{
  "id": "population-constant-per-capita-3",
  "level": "2",
  "url": "population-discrete.html#population-constant-per-capita-3",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "recursive equation geometric sequence explicit formula "
},
{
  "id": "population-constant-per-capita-4",
  "level": "2",
  "url": "population-discrete.html#population-constant-per-capita-4",
  "type": "Example",
  "number": "2.2.2",
  "title": "",
  "body": "  A population of size 400 is tracked for one month, during which time there are 50 births and 40 deaths. If the population has constant per capita rates, what will be the predicted population after one year?    Constant per capita rates mean that we can compute and from this observation and use them in our model: Consequently, our population model is given by the recursive formula with an initial value . The index variable is counting months of observation.  The explicit formula for this model is given by The population after a year corresponds to (12 months after starting), which has a value Under the assumptions of our model, namely constant per capita growth rates, we would predict a population of 538 individuals after one year.   "
},
{
  "id": "population-density-dependent-5",
  "level": "2",
  "url": "population-discrete.html#population-density-dependent-5",
  "type": "Example",
  "number": "2.2.3",
  "title": "",
  "body": " If we revisited the density-dependent agent-based model in Section , we can plot the per capita net growth rate computed at each time step with respect to the size of the population at the beginning of the step. The figure below illustrates this relationship. (Values when the population was small and demographic stochasticity is high were not included.)     We see in the graph that the per capita net growth rate is decreasing. The data seem consistent with a model where the per capita rate decreases linearly. This makes sense because the rules of the agent-based model were that the death rate increased linearly in terms of the number of individuals on a shared patch.  "
},
{
  "id": "population-density-dependent-6",
  "level": "2",
  "url": "population-discrete.html#population-density-dependent-6",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "parametric formula parameter "
},
{
  "id": "population-density-dependent-7",
  "level": "2",
  "url": "population-discrete.html#population-density-dependent-7",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "intrinsic per capita net growth rate "
},
{
  "id": "population-density-dependent-8",
  "level": "2",
  "url": "population-discrete.html#population-density-dependent-8",
  "type": "Example",
  "number": "2.2.5",
  "title": "",
  "body": " Using the density dependent data from our agent-based model, we can use linear regression to find a line of best fit. This gives us the following values for the parameters: The resulting parametric model for the per capita growth rate is then given by A graph showing the trend line with the data is given below.     "
},
{
...
},
{
  ...
  "number": "2.3.1",
  "title": "",
  "body": " The difference equation with an initial value defines a sequence recursively. If we solve this equation for , we get a function of : The function being used, , is the projection function.  "
},
{
  ...
  "number": "2.3.2",
  "title": "",
  "body": " In Calculus, Newton's method to find the positive square root of any positive number , which is the positive solution to , involves creating a sequence that satisfies the recursive equation Solving this equation for , we find the equation that writes as a function of , The projection function in this example is  "
},
{
  "id": "projection-functions-6",
  "level": "2",
  "url": "population-projection.html#projection-functions-6",
  "type": "Example",
  "number": "2.3.3",
  "title": "",
...
{
  "id": "projection-fixed-points-7",
  "level": "2",
  "url": "population-projection.html#projection-fixed-points-7",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  ...
  "number": "2.4.1",
  "title": "",
  "body": " Consider a population model that uses a constant per capita growth rate for which we introduce an emigration term that is constant, say (for migration). Then our population model would be which using sequences would be written The projection function for this model is linear with a slope given by  "
},
{
...
},
{
  ...
  "number": "2.4.3",
  "title": "",
  "body": "  A loan balance grows by of the annual percentage rate each month. But a monthly payment reduces the loan balance. Write down a recursive model for the loan balance where is the number of months since the loan began, is the annual percentage rate and is the amount of the monthly payment.    The recursive model for the loan balance is motivated by the descriptive equation Our recursive model is The projection function as is linear with slope .   "
},
{
...
},
{
  ...
  "body": " Stability of Fixed Points for Linear Projection Functions   For a projection function with fixed point the stability of the fixed point as an equilibrium for a sequence defined as is determined by the value of the slope .  If , then every sequence converges and is a stable equilibrium.  If , then every sequence with diverges away from and is an unstable equilibrium.  If , then the sequence alternates between two values and is neutrally stable as the sequence does not diverge.  If and ( ), then every number is a fixed point. If , then no fixed point exists.    "
},
{
...
},
{
  ...
  "number": "2.4.7",
  "title": "",
  "body": "  If a function is differentiable at ( exists), then we can define the linear approximation of around as the linear function with slope and passing through the point given by When is sufficiently close to , the functions are nearly indistinguishable.    The tangent line equation is a consequence of standard calculus definitions. To clarify the idea of sufficiently close without trying to recreate an entire course in analysis, let us start by pointing out that because exists, the average rate of change defined by must converge to as approaches , as given in the limit This is equivalent to saying This can be rewritten as Because the denominator goes to zero, the numerator must go to zero even faster for the limit to equal zero.   "
},
{
  ...
  "body": " Stability of Fixed Points for Projection Functions   Suppose a projection function has a fixed point at and exists. So long as , the local stability of the fixed point is determined by the value of as follows.  If , then is a stable fixed point.  If , then is an unstable fixed point.    "
},
{
  "id": "projection-analysis-5-5",
  "level": "2",
  "url": "projection-analysis.html#projection-analysis-5-5",
  "type": "Example",
  "number": "2.4.9",
  "title": "",
  "body": " Find the fixed points of the projection function .   This shows that the fixed points are and . Sage internally stored those values as two equations in the list named fixPoints . Sage refers to entries in a list like a sequence, with the first value having index 0. That is, fixPoints[0] corresponds to the equation x==0 .  The next step is to compute the derivative at each fixed point. In Sage, we will compute the derivative using the derivative command, which expects a formula and the variable of differentiation. We will define a new function , but the apostrophe in Sage represents a quotation and not a derivative. So let us use df(x) in place of . We can evaluate the derivative at our fixed point if we use a substitution based on our equations in fixPoints . The following commands must be done after the previous script has already been evaluated.   We can interpret our results for the projection function At the fixed point , has slope . Since , we know that the fixed point is unstable and the sequence diverges away from the equilibrium. On the other hand, at the second fixed has slope so that . This fixed point is stable and a sequence nearby would converge to that value. You can explore the dynamics of this sequence in the graph below, choosing different initial values.   Dynamic graph illustrating the sequence generated by where a slider selects the initial value.    "
},
{
