...
},
{
  ...
  "number": "4.1.8",
  "title": "",
  "body": "  # Start adding solutions as additional layers soln_curves <- slope_field + geom_function(fun = function(t) { 0.5*exp(3*t) }, linewidth=1) + geom_function(fun = function(t) { 0.01*exp(3*t) }, linewidth=1) + geom_function(fun = function(t) { -0.04*exp(3*t) }, linewidth=1) + geom_function(fun = function(t) { -1*exp(3*t) }, linewidth=1) + ylim(-4, 4) # Required to keep the same viewing window show(soln_curves)   "
},
{
